               ...
               if(mysqli_num_rows($result) > 0){
                ...
                while($row = mysqli_fetch_assoc($result)){
                    echo"<tr>";
                        ...
                        echo"<td><a href='edit_form_food.php?id=".$row['id']."'>แก้ไข</a></td>";

                        echo"<td><a href='data2.php?delete_id=".$row['id']."'
...
<br>
<center>
    <button type="button" class="btn btn-light"><a href="add_form_food.php">เพิ่มข้อมูล</button>
</center>
